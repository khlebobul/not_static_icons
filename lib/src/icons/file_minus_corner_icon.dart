...
/// Animated File Minus Corner Icon - corner minus compresses
class FileMinusCornerIcon extends AnimatedSVGIcon {
  ...
  @override
  String get animationDescription => "corner minus compresses";
...
class FileMinusCornerPainter extends CustomPainter {
  final Color color;
  final double animationValue;
  final double strokeWidth;

  FileMinusCornerPainter({
    required this.color,
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final path0 = Path();
    path0.moveTo(20 * scale, 14 * scale);
    ...
    canvas.scale(1 - pulse * .12, 1);
    canvas.translate(-center.dx, -center.dy);
    final path2 = Path();
    path2.moveTo(14 * scale, 18 * scale);
  ...
  @override
  bool shouldRepaint(FileMinusCornerPainter oldDelegate) {
