...
/// Animated Dice 4 Icon - die rocks and corner pips pulse
class Dice4Icon extends AnimatedSVGIcon {
  const Dice4Icon({
    super.key,
    super.size = 40.0,
    super.color,
  ...
  @override
  String get animationDescription => 'Die rocks and corner pips pulse';
  ...
  CustomPainter createPainter({
    ...
    required double strokeWidth,
      ...
      _Dice4Painter(color, animationValue, strokeWidth);
}

class _Dice4Painter extends CustomPainter {
  final Color color;
  final double animationValue;
  final double strokeWidth;

  _Dice4Painter(this.color, this.animationValue, this.strokeWidth);
  ...
  @override
  bool shouldRepaint(_Dice4Painter old) =>
      old.color != color ||
