...
class CablePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // M17 21v-2
    canvas.drawLine(
        Offset(17 * scale, 21 * scale), Offset(17 * scale, 19 * scale), paint);
    // M21 21v-2
    canvas.drawLine(
        Offset(21 * scale, 21 * scale), Offset(21 * scale, 19 * scale), paint);

    // Left Plug (Static)
    // M4 10a2 2 0 0 1-2-2V6a1 1 0 0 1 1-1h4a1 1 0 0 1 1 1v2a2 2 0 0 1-2 2z
    final leftPlug = Path();
    leftPlug.moveTo(4 * scale, 10 * scale);
    leftPlug.arcToPoint(Offset(2 * scale, 8 * scale),
        radius: Radius.circular(2 * scale), clockwise: true);
    leftPlug.lineTo(2 * scale, 6 * scale);
    leftPlug.arcToPoint(Offset(3 * scale, 5 * scale),
        radius: Radius.circular(1 * scale), clockwise: true);
    leftPlug.lineTo(7 * scale, 5 * scale);
    leftPlug.arcToPoint(Offset(8 * scale, 6 * scale),
        radius: Radius.circular(1 * scale), clockwise: true);
    leftPlug.lineTo(8 * scale, 8 * scale);
    leftPlug.arcToPoint(Offset(6 * scale, 10 * scale),
        radius: Radius.circular(2 * scale), clockwise: true);
    leftPlug.close();
    ...
    // M3 5V3
    canvas.drawLine(
        Offset(3 * scale, 5 * scale), Offset(3 * scale, 3 * scale), paint);
    // M7 5V3
    canvas.drawLine(
        Offset(7 * scale, 5 * scale), Offset(7 * scale, 3 * scale), paint);
    ...
    cablePath.cubicTo(19 * scale, 2 * scale, (12 + sway) * scale, 2 * scale,
    ...
    cablePath.cubicTo((12 + sway) * scale, 22 * scale, 5 * scale, 22 * scale,
        5 * scale, 17.5 * scale);
