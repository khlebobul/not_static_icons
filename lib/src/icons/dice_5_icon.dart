...
/// Animated Dice 5 Icon - die rocks and pips pulse
class Dice5Icon extends AnimatedSVGIcon {
  const Dice5Icon({
    super.key,
    super.size = 40.0,
    super.color,
  ...
  CustomPainter createPainter({
    ...
    required double strokeWidth,
      ...
      _Dice5Painter(color, animationValue, strokeWidth);
}

class _Dice5Painter extends CustomPainter {
  final Color color;
  final double animationValue;
  final double strokeWidth;

  _Dice5Painter(this.color, this.animationValue, this.strokeWidth);
  ...
  @override
  bool shouldRepaint(_Dice5Painter old) =>
      old.color != color ||
