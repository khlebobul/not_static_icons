...
/// Animated Dice 3 Icon - die rocks and pips pulse on hover/tap
class Dice3Icon extends AnimatedSVGIcon {
  const Dice3Icon({
    super.key,
    super.size = 40.0,
    super.color,
  ...
  @override
  String get animationDescription => 'Die rocks and pips pulse';
  ...
  CustomPainter createPainter({
    ...
    required double strokeWidth,
      ...
      _Dice3Painter(color, animationValue, strokeWidth);
}

class _Dice3Painter extends CustomPainter {
  final Color color;
  final double animationValue;
  final double strokeWidth;

  _Dice3Painter(this.color, this.animationValue, this.strokeWidth);
  ...
  void paint(Canvas canvas, Size size) {
    ...
    _drawDie(
        canvas, s, paint, t, [Offset(16, 8), Offset(12, 12), Offset(8, 16)]);
  }

  @override
  bool shouldRepaint(_Dice3Painter old) =>
      old.color != color ||
