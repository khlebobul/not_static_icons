...
class CalendarOffPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    bodyPath1.arcToPoint(Offset(3 * scale, 6 * scale), radius: Radius.circular(2 * scale), clockwise: false);
    bodyPath1.lineTo(3 * scale, 20 * scale);
    bodyPath1.arcToPoint(Offset(5 * scale, 22 * scale), radius: Radius.circular(2 * scale), clockwise: false);
    bodyPath1.lineTo(19 * scale, 22 * scale);
    bodyPath1.arcToPoint(Offset(20.82 * scale, 20.82 * scale), radius: Radius.circular(2 * scale), clockwise: false);
    ...
    bodyPath2.arcToPoint(Offset(19 * scale, 4 * scale), radius: Radius.circular(2 * scale), clockwise: false);
    ...
    // M3 10h7
    canvas.drawLine(Offset(3 * scale, 10 * scale), Offset(10 * scale, 10 * scale), paint);
    // M21 10h-5.5
    canvas.drawLine(Offset(21 * scale, 10 * scale), Offset(15.5 * scale, 10 * scale), paint);
