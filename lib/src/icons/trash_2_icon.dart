...
/// Animated Trash 2 Icon - Lid opens with lines inside
class Trash2Icon extends AnimatedSVGIcon {
  const Trash2Icon({
    super.key,
    super.size = 40.0,
    super.color,
...
/// Painter for Trash 2 icon
class Trash2Painter extends CustomPainter {
  final Color color;
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Inner lines: M10 11v6 and M14 11v6
    canvas.drawLine(
  ...
  @override
  bool shouldRepaint(Trash2Painter oldDelegate) {
