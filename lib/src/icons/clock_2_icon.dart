...
/// Animated Clock 2 Icon - Clock hands rotate
class Clock2Icon extends AnimatedSVGIcon {
  const Clock2Icon({
    super.key,
    super.size = 40.0,
    super.color,
...
class Clock2Painter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawLine(
        Offset(12 * scale, 12 * scale), Offset(16 * scale, 10 * scale), paint);

    canvas.restore();
  }

  @override
  bool shouldRepaint(Clock2Painter oldDelegate) {
