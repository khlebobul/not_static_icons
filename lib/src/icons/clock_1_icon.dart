...
/// Animated Clock 1 Icon - Clock hands rotate
class Clock1Icon extends AnimatedSVGIcon {
  const Clock1Icon({
    super.key,
    super.size = 40.0,
    super.color,
...
class Clock1Painter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawLine(
        Offset(12 * scale, 12 * scale), Offset(14 * scale, 8 * scale), paint);
