...
class ClipboardPenLinePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    boardPath.arcToPoint(Offset(20 * scale, 20 * scale), radius: Radius.circular(2 * scale), clockwise: false);
    ...
    topPath.arcToPoint(Offset(19.73 * scale, 5 * scale), radius: Radius.circular(2 * scale), clockwise: true);
    canvas.drawPath(topPath, paint);

    canvas.drawLine(Offset(8 * scale, 18 * scale), Offset(9 * scale, 18 * scale), paint);
    ...
    penPath.arcToPoint(Offset(18.374 * scale, 9.622 * scale), radius: Radius.circular(1 * scale), clockwise: false, largeArc: true);
    penPath.lineTo(14.364 * scale, 13.634 * scale);
    penPath.cubicTo(14.1 * scale, 13.9 * scale, 13.9 * scale, 14.2 * scale, 13.858 * scale, 14.488 * scale);
    penPath.lineTo(13.021 * scale, 17.358 * scale);
    penPath.arcToPoint(Offset(13.641 * scale, 17.978 * scale), radius: Radius.circular(0.5 * scale), clockwise: true);
    penPath.lineTo(16.511 * scale, 17.141 * scale);
    penPath.cubicTo(16.8 * scale, 17.1 * scale, 17.1 * scale, 16.9 * scale, 17.365 * scale, 16.635 * scale);
    penPath.close();
