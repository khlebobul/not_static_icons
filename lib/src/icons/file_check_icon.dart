...
/// Animated File Check Icon - check mark snaps in
class FileCheckIcon extends AnimatedSVGIcon {
  const FileCheckIcon({
    super.key,
    super.size = 40.0,
    super.color,
  ...
  @override
  String get animationDescription => "check mark snaps in";
...
class FileCheckPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path2.lineTo(11 * scale, 17 * scale);
    path2.lineTo(15 * scale, 13 * scale);
