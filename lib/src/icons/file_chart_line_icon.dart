...
/// Animated File Chart Line Icon - line chart jumps
class FileChartLineIcon extends AnimatedSVGIcon {
  ...
  @override
  String get animationDescription => "line chart jumps";
...
class FileChartLinePainter extends CustomPainter {
  final Color color;
  final double animationValue;
  final double strokeWidth;

  FileChartLinePainter({
    required this.color,
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final path2 = Path();
    path2.moveTo(16 * scale, 13 * scale);
    path2.lineTo((12.5 + pulse * 3.5) * scale, (16.5 - pulse * 3.5) * scale);
    path2.lineTo((10.5 + pulse * 5.5) * scale, (14.5 - pulse * 1.5) * scale);
    path2.lineTo((8 + pulse * 8) * scale, (17 - pulse * 4) * scale);
    canvas.drawPath(path2, paint);
  }

  @override
  bool shouldRepaint(FileChartLinePainter oldDelegate) {
