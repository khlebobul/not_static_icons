...
/// Animated File Up Icon - arrow uploads
class FileUpIcon extends AnimatedSVGIcon {
  const FileUpIcon({
    super.key,
    super.size = 40.0,
    super.color,
  ...
  @override
  String get animationDescription => "arrow uploads";
...
class FileUpPainter extends CustomPainter {
  final Color color;
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final path2 = Path();
    path2.moveTo(12 * scale, 12 * scale);
    path2.lineTo(12 * scale, 18 * scale);
    canvas.drawPath(path2, paint);
    final path3 = Path();
    path3.moveTo(15 * scale, 15 * scale);
    path3.lineTo(12 * scale, 12 * scale);
    path3.lineTo(9 * scale, 15 * scale);
    canvas.drawPath(path3, paint);
    canvas.restore();
  }

  @override
  bool shouldRepaint(FileUpPainter oldDelegate) {
