...
/// Animated Clock 12 Icon - Clock hands rotate
class Clock12Icon extends AnimatedSVGIcon {
  const Clock12Icon({
    super.key,
    super.size = 40.0,
    super.color,
...
class Clock12Painter extends CustomPainter {
  final Color color;
  ...
  @override
  bool shouldRepaint(Clock12Painter oldDelegate) {
