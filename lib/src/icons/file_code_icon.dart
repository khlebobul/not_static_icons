...
/// Animated File Code Icon - code brackets slide
class FileCodeIcon extends AnimatedSVGIcon {
  const FileCodeIcon({
    super.key,
    super.size = 40.0,
    super.color,
  ...
  @override
  String get animationDescription => "code brackets slide";
...
class FileCodePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final path2 = Path();
    path2.moveTo(10 * scale, 12.5 * scale);
    path2.lineTo(8 * scale, 15 * scale);
    path2.lineTo(10 * scale, 17.5 * scale);
    canvas.drawPath(path2, paint);
    final path3 = Path();
    path3.moveTo(14 * scale, 12.5 * scale);
    path3.lineTo(16 * scale, 15 * scale);
    path3.lineTo(14 * scale, 17.5 * scale);
