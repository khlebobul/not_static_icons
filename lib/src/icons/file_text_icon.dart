...
/// Animated File Text Icon - text lines slide
class FileTextIcon extends AnimatedSVGIcon {
  const FileTextIcon({
    super.key,
    super.size = 40.0,
    super.color,
  ...
  @override
  String get animationDescription => "text lines slide";
...
class FileTextPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final path2 = Path();
    path2.moveTo(10 * scale, 9 * scale);
    path2.lineTo(8 * scale, 9 * scale);
    canvas.drawPath(path2, paint);
    final path3 = Path();
    path3.moveTo(16 * scale, 13 * scale);
    path3.lineTo(8 * scale, 13 * scale);
    canvas.drawPath(path3, paint);
    final path4 = Path();
    path4.moveTo(16 * scale, 17 * scale);
    path4.lineTo(8 * scale, 17 * scale);
