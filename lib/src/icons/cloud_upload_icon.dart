...
/// Animated Cloud Upload Icon - Arrow moves up
class CloudUploadIcon extends AnimatedSVGIcon {
...
class CloudUploadPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Arrow line: M12 21v-8
    canvas.drawLine(
        Offset(12 * scale, 21 * scale), Offset(12 * scale, 13 * scale), paint);

    // Arrow head: m-4 4 and m12 13 4 4
    final arrowHead = Path();
    arrowHead.moveTo(8 * scale, 17 * scale);
    arrowHead.lineTo(12 * scale, 13 * scale);
  ...
  @override
  bool shouldRepaint(CloudUploadPainter oldDelegate) {
