...
/// Animated File Chart Column Icon - columns rise
class FileChartColumnIcon extends AnimatedSVGIcon {
  const FileChartColumnIcon({
    super.key,
    super.size = 40.0,
    super.color,
    super.hoverColor,
  ...
  @override
  String get animationDescription => "columns rise";
...
class FileChartColumnPainter extends CustomPainter {
  final Color color;
  final double animationValue;
  final double strokeWidth;

  FileChartColumnPainter({
    required this.color,
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path2.lineTo(8 * scale, (17 + pulse) * scale);
    canvas.drawPath(path2, paint);
    final path3 = Path();
    path3.moveTo(12 * scale, 18 * scale);
    path3.lineTo(12 * scale, (12 + pulse * 6) * scale);
    canvas.drawPath(path3, paint);
    final path4 = Path();
    path4.moveTo(16 * scale, 18 * scale);
    path4.lineTo(16 * scale, (15 + pulse * 3) * scale);
    canvas.drawPath(path4, paint);
  }

  @override
  bool shouldRepaint(FileChartColumnPainter oldDelegate) {
