...
/// Animated Dice 6 Icon - die rocks and pips pulse
class Dice6Icon extends AnimatedSVGIcon {
  const Dice6Icon({
    super.key,
    super.size = 40.0,
    super.color,
  ...
  CustomPainter createPainter({
    ...
    required double strokeWidth,
      ...
      _Dice6Painter(color, animationValue, strokeWidth);
}

class _Dice6Painter extends CustomPainter {
  final Color color;
  final double animationValue;
  final double strokeWidth;

  _Dice6Painter(this.color, this.animationValue, this.strokeWidth);
  ...
  @override
  bool shouldRepaint(_Dice6Painter old) =>
      old.color != color ||
