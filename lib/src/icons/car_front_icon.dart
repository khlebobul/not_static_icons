...
/// Animated Car Front Icon - Car rocks side to side
class CarFrontIcon extends AnimatedSVGIcon {
  const CarFrontIcon({
    super.key,
    super.size = 40.0,
    super.color,
...
class CarFrontPainter extends CustomPainter {
  ...
  @override
  bool shouldRepaint(CarFrontPainter oldDelegate) {
