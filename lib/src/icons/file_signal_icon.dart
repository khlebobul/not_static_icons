...
/// Animated File Signal Icon - signal bars rise
class FileSignalIcon extends AnimatedSVGIcon {
  const FileSignalIcon({
    super.key,
    super.size = 40.0,
    super.color,
    super.hoverColor,
  ...
  @override
  String get animationDescription => "signal bars rise";
...
class FileSignalPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final path2 = Path();
    path2.moveTo(8 * scale, 15 * scale);
    path2.lineTo(8.01 * scale, 15 * scale);
    canvas.drawPath(path2, paint);
    canvas.save();
    canvas.translate(pulse * .45 * scale, 0);
    final path3 = Path();
    path3.moveTo(11.5 * scale, 13.5 * scale);
    path3.arcToPoint(Offset(11.5 * scale, 16.5 * scale),
    ...
    final path4 = Path();
    path4.moveTo(15 * scale, 12 * scale);
    path4.arcToPoint(Offset(15 * scale, 18 * scale),
