...
class _BrainCogPainter extends CustomPainter {
  ...
  void _drawBrainOutline(Canvas canvas, Paint paint, double scale) {
    ...
    final bottomBrain = Path()
      ...
      ..cubicTo(
        11.644 * scale, 19.689 * scale,
        12.356 * scale, 19.689 * scale,
        12.536 * scale, 20 * scale,
      )
      ..arcToPoint(
  ...
  void _drawCogGear(Canvas canvas, Paint paint, double scale, double rotation) {
    ...
    final cogLines = [
      {'start': 'm10.852 14.772-.383.923', 'p1': Offset(10.852, 14.772), 'p2': Offset(10.469, 15.695)},
      {'start': 'm10.852 9.228-.383-.923', 'p1': Offset(10.852, 9.228), 'p2': Offset(10.469, 8.305)},
      {'start': 'm13.148 14.772.382.924', 'p1': Offset(13.148, 14.772), 'p2': Offset(13.53, 15.696)},
      {'start': 'm13.531 8.305-.383.923', 'p1': Offset(13.531, 8.305), 'p2': Offset(13.148, 9.228)},
      {'start': 'm14.772 10.852.923-.383', 'p1': Offset(14.772, 10.852), 'p2': Offset(15.695, 10.469)},
      {'start': 'm14.772 13.148.923.383', 'p1': Offset(14.772, 13.148), 'p2': Offset(15.695, 13.531)},
      {'start': 'm9.228 10.852-.923-.383', 'p1': Offset(9.228, 10.852), 'p2': Offset(8.305, 10.469)},
      {'start': 'm9.228 13.148-.923.383', 'p1': Offset(9.228, 13.148), 'p2': Offset(8.305, 13.531)},
    ];
