...
/// Animated Book Down Icon - arrow moving down animation
class BookDownIcon extends AnimatedSVGIcon {
  const BookDownIcon({
    super.key,
    super.size = 40.0,
    super.color,
  ...
  @override
  String get animationDescription => 'BookDown: arrow moving down animation';
...
class _BookDownPainter extends CustomPainter {
  final Color color;
  ...
  void _drawCompleteIcon(Canvas canvas, Paint paint, double scale) {
    ...
    final arrowPath = Path()
      ..moveTo(9 * scale, 10 * scale)
      ..lineTo(12 * scale, 13 * scale)
      ..lineTo(15 * scale, 10 * scale);
  ...
  void _drawAnimatedArrow(Canvas canvas, Paint paint, double scale) {
    ...
    // Arrow moves down and returns
    final moveProgress = math.sin(progress * math.pi);
    final offsetY = moveProgress * 2 * scale;

    canvas.save();
    canvas.translate(0, offsetY);

    // Vertical line: M12 13V7 (but drawn as M12 7V6)
    canvas.drawLine(
      Offset(12 * scale, 7 * scale),
      Offset(12 * scale, 13 * scale),
      paint,
    ...
    arrowPath.lineTo(12 * scale, 13 * scale);
    arrowPath.lineTo(15 * scale, 10 * scale);
  ...
  @override
  bool shouldRepaint(_BookDownPainter oldDelegate) {
