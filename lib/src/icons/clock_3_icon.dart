...
/// Animated Clock 3 Icon - Clock hands rotate
class Clock3Icon extends AnimatedSVGIcon {
  const Clock3Icon({
    super.key,
    super.size = 40.0,
    super.color,
...
class Clock3Painter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawLine(
        Offset(12 * scale, 12 * scale), Offset(16 * scale, 12 * scale), paint);
