...
/// Animated Clock Arrow Up Icon - Clock hands rotate with arrow
class ClockArrowUpIcon extends AnimatedSVGIcon {
  const ClockArrowUpIcon({
    super.key,
    super.size = 40.0,
    super.color,
    super.hoverColor,
...
class ClockArrowUpPainter extends CustomPainter {
  final Color color;
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Partial circle: M13.227 21.925a10 10 0 1 1 8.767-9.588
    final circlePath = Path();
    circlePath.moveTo(13.227 * scale, 21.925 * scale);
    circlePath.arcToPoint(
      Offset(21.994 * scale, 12.337 * scale),
    ...
    canvas.drawLine(Offset(12 * scale, 12 * scale),
        Offset(13.56 * scale, 12.78 * scale), paint);

    canvas.restore();

    // Arrow up with smooth up movement animation
    ...
    arrowHead.lineTo(18 * scale, 14 * scale);
  ...
  @override
  bool shouldRepaint(ClockArrowUpPainter oldDelegate) {
