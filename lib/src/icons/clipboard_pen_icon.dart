...
class ClipboardPenPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    boardPath.arcToPoint(Offset(20 * scale, 6 * scale), radius: Radius.circular(2 * scale), clockwise: true);
    ...
    leftPath.arcToPoint(Offset(4 * scale, 20 * scale), radius: Radius.circular(2 * scale), clockwise: true);
    leftPath.lineTo(4 * scale, 6 * scale);
    leftPath.arcToPoint(Offset(6 * scale, 4 * scale), radius: Radius.circular(2 * scale), clockwise: true);
    ...
    penPath.arcToPoint(Offset(18.336 * scale, 12.66 * scale), radius: Radius.circular(1 * scale), clockwise: false, largeArc: true);
    penPath.lineTo(13.326 * scale, 17.672 * scale);
    penPath.cubicTo(13.1 * scale, 17.9 * scale, 12.9 * scale, 18.2 * scale, 12.82 * scale, 18.526 * scale);
    penPath.lineTo(11.983 * scale, 21.396 * scale);
    penPath.arcToPoint(Offset(12.603 * scale, 22.016 * scale), radius: Radius.circular(0.5 * scale), clockwise: true);
    penPath.lineTo(15.473 * scale, 21.179 * scale);
    penPath.cubicTo(15.8 * scale, 21.1 * scale, 16.1 * scale, 20.9 * scale, 16.327 * scale, 20.673 * scale);
    penPath.close();
