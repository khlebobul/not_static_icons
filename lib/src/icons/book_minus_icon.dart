...
/// Animated Book Minus Icon - minus line drawing animation
class BookMinusIcon extends AnimatedSVGIcon {
  const BookMinusIcon({
    super.key,
    super.size = 40.0,
    super.color,
  ...
  @override
  String get animationDescription => 'BookMinus: minus line drawing animation';
...
class _BookMinusPainter extends CustomPainter {
  final Color color;
  ...
  void _drawAnimatedMinus(Canvas canvas, Paint paint, double scale) {
    ...
    // Draw line from center outwards in both directions
  ...
  @override
  bool shouldRepaint(_BookMinusPainter oldDelegate) {
