...
/// Animated File Axis 3D Icon - axes orbit
class FileAxis3DIcon extends AnimatedSVGIcon {
  const FileAxis3DIcon({
    super.key,
    super.size = 40.0,
    super.color,
    super.hoverColor,
  ...
  @override
  String get animationDescription => "axes orbit";
...
class FileAxis3DPainter extends CustomPainter {
  final Color color;
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final path2 = Path();
    path2.moveTo((8 + pulse * 4) * scale, (18 - pulse * 4) * scale);
    path2.lineTo(12 * scale, 14 * scale);
    canvas.drawPath(path2, paint);
    final path3 = Path();
    path3.moveTo(8 * scale, (10 + pulse * 8) * scale);
    path3.lineTo(8 * scale, 18 * scale);
    path3.lineTo((16 - pulse * 8) * scale, 18 * scale);
    canvas.drawPath(path3, paint);
  }

  @override
  bool shouldRepaint(FileAxis3DPainter oldDelegate) {
