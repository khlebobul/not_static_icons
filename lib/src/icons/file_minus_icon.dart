...
/// Animated File Minus Icon - minus compresses
class FileMinusIcon extends AnimatedSVGIcon {
  const FileMinusIcon({
    super.key,
    super.size = 40.0,
    super.color,
  ...
  @override
  String get animationDescription => "minus compresses";
