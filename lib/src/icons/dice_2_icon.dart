...
/// Animated Dice 2 Icon - die rocks and pips pulse on hover/tap
class Dice2Icon extends AnimatedSVGIcon {
  const Dice2Icon({
    super.key,
    super.size = 40.0,
    super.color,
  ...
  CustomPainter createPainter({
    ...
    required double strokeWidth,
      ...
      _Dice2Painter(color, animationValue, strokeWidth);
}

class _Dice2Painter extends CustomPainter {
  final Color color;
  final double animationValue;
  final double strokeWidth;

  _Dice2Painter(this.color, this.animationValue, this.strokeWidth);
  ...
  void paint(Canvas canvas, Size size) {
    ...
    _drawDie(canvas, s, paint, t, [Offset(15, 9), Offset(9, 15)]);
  }

  @override
  bool shouldRepaint(_Dice2Painter old) =>
      old.color != color ||
