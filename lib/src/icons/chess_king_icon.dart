...
class ChessKingPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    bodyPath.cubicTo(4.35 * scale, 15.682 * scale, 3 * scale, 14.09 * scale, 3 * scale, 12 * scale);
    bodyPath.arcToPoint(Offset(7.95 * scale, 7 * scale), radius: Radius.circular(5 * scale), clockwise: true);
    bodyPath.cubicTo(9.534 * scale, 7 * scale, 10.65 * scale, 7.455 * scale, 12 * scale, 8.818 * scale);
    bodyPath.cubicTo(13.35 * scale, 7.455 * scale, 14.466 * scale, 7 * scale, 16.05 * scale, 7 * scale);
    bodyPath.arcToPoint(Offset(21 * scale, 12 * scale), radius: Radius.circular(5 * scale), clockwise: true);
    bodyPath.cubicTo(21 * scale, 14.082 * scale, 19.641 * scale, 15.673 * scale, 18.3 * scale, 17 * scale);
