...
/// Animated Clock 4 Icon - Clock hands rotate
class Clock4Icon extends AnimatedSVGIcon {
  const Clock4Icon({
    super.key,
    super.size = 40.0,
    super.color,
...
class Clock4Painter extends CustomPainter {
  final Color color;
  ...
  @override
  bool shouldRepaint(Clock4Painter oldDelegate) {
