...
/// Animated File Input Icon - arrow enters file
class FileInputIcon extends AnimatedSVGIcon {
  const FileInputIcon({
    super.key,
    super.size = 40.0,
    super.color,
  ...
  @override
  String get animationDescription => "arrow enters file";
...
class FileInputPainter extends CustomPainter {
  final Color color;
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final path2 = Path();
    path2.moveTo(2 * scale, 15 * scale);
    path2.lineTo(12 * scale, 15 * scale);
    canvas.drawPath(path2, paint);
    final path3 = Path();
    path3.moveTo(9 * scale, 18 * scale);
    path3.lineTo(12 * scale, 15 * scale);
    path3.lineTo(9 * scale, 12 * scale);
    canvas.drawPath(path3, paint);
    canvas.restore();
  }

  @override
  bool shouldRepaint(FileInputPainter oldDelegate) {
