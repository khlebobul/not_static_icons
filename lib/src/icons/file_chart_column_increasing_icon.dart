...
/// Animated File Chart Column Increasing Icon - columns climb
class FileChartColumnIncreasingIcon extends AnimatedSVGIcon {
  const FileChartColumnIncreasingIcon({
    super.key,
    super.size = 40.0,
    super.color,
    super.hoverColor,
  ...
  @override
  String get animationDescription => "columns climb";
  ...
  CustomPainter createPainter({
    ...
    return FileChartColumnIncreasingPainter(
      color: color,
...
class FileChartColumnIncreasingPainter extends CustomPainter {
  final Color color;
  final double animationValue;
  final double strokeWidth;

  FileChartColumnIncreasingPainter({
    required this.color,
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final path2 = Path();
    path2.moveTo(8 * scale, 18 * scale);
    path2.lineTo(8 * scale, (16 + pulse * 2) * scale);
    canvas.drawPath(path2, paint);
    final path3 = Path();
    path3.moveTo(12 * scale, 18 * scale);
    path3.lineTo(12 * scale, (14 + pulse * 4) * scale);
    canvas.drawPath(path3, paint);
    final path4 = Path();
    path4.moveTo(16 * scale, 18 * scale);
    path4.lineTo(16 * scale, (12 + pulse * 6) * scale);
    canvas.drawPath(path4, paint);
  }

  @override
  bool shouldRepaint(FileChartColumnIncreasingPainter oldDelegate) {
