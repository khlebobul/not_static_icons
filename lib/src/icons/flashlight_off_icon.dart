...
/// Animated FlashlightOff icon.
class FlashlightOffIcon extends AnimatedSVGIcon {
  ...
  @override
  String get animationDescription => 'switch clicks and slash cuts the beam';
...
class _FlashlightOffPainter extends CustomPainter {
  const _FlashlightOffPainter({
    required this.color,
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final path = Path()
      ...
      ..lineTo(16.8, 9.6)
      ..arcToPoint(const Offset(16.25, 10.607),
          radius: const Radius.circular(4), clockwise: false);
    ...
    canvas.drawPath(
      metric.extractPath(0, metric.length * (1 - t * .4)),
      paint,
    );
    canvas.restore();
  }
  ...
  @override
  bool shouldRepaint(_FlashlightOffPainter oldDelegate) =>
