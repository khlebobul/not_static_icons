...
/// Animated File X Corner Icon - corner x shakes
class FileXCornerIcon extends AnimatedSVGIcon {
  const FileXCornerIcon({
    super.key,
    super.size = 40.0,
    super.color,
    super.hoverColor,
  ...
  @override
  String get animationDescription => "corner x shakes";
...
class FileXCornerPainter extends CustomPainter {
  final Color color;
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final path0 = Path();
    path0.moveTo(11 * scale, 22 * scale);
    ...
    path0.arcToPoint(Offset(20 * scale, 8 * scale),
        radius: Radius.circular(2.4 * scale));
    path0.lineTo(20 * scale, 13 * scale);
    ...
    final path2 = Path();
    path2.moveTo(15 * scale, 17 * scale);
    path2.lineTo(20 * scale, 22 * scale);
    canvas.drawPath(path2, paint);
    final path3 = Path();
    path3.moveTo(20 * scale, 17 * scale);
    path3.lineTo(15 * scale, 22 * scale);
    canvas.drawPath(path3, paint);
    canvas.restore();
  }

  @override
  bool shouldRepaint(FileXCornerPainter oldDelegate) {
