...
/// Animated File Question Mark Icon - question mark wobbles
class FileQuestionMarkIcon extends AnimatedSVGIcon {
  const FileQuestionMarkIcon({
    super.key,
    super.size = 40.0,
    super.color,
    super.hoverColor,
  ...
  @override
  String get animationDescription => "question mark wobbles";
  ...
  CustomPainter createPainter({
    ...
    return FileQuestionMarkPainter(
      color: color,
...
class FileQuestionMarkPainter extends CustomPainter {
  final Color color;
  final double animationValue;
  final double strokeWidth;

  FileQuestionMarkPainter({
    required this.color,
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final path1 = Path();
    path1.moveTo(12 * scale, 17 * scale);
    path1.lineTo(12.01 * scale, 17 * scale);
    ...
    canvas.translate(-center.dx, -center.dy);
    final path2 = Path();
    path2.moveTo(9.1 * scale, 9 * scale);
    path2.arcToPoint(Offset(14.92 * scale, 10 * scale),
        radius: Radius.circular(3 * scale));
    path2.cubicTo(14.92 * scale, 12 * scale, 11.92 * scale, 13 * scale,
  ...
  @override
  bool shouldRepaint(FileQuestionMarkPainter oldDelegate) {
