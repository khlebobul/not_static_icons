...
/// Animated Grid Plus 4 Icon - Grid with plus and number 4
class GridPlus4Icon extends AnimatedSVGIcon {
  const GridPlus4Icon({
    super.key,
    super.size = 40.0,
    super.color,
  ...
  @override
  String get animationDescription => "Grid Plus 4 animates";
...
/// Painter for Grid Plus 4 icon
class GridPlus4Painter extends CustomPainter {
  final Color color;
  ...
  @override
  bool shouldRepaint(GridPlus4Painter oldDelegate) {
