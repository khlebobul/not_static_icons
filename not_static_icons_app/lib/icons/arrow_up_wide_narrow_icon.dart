...
class ArrowUpWideNarrowIcon extends AnimatedSVGIcon {
  const ArrowUpWideNarrowIcon({
    super.key,
    super.size = 40,
  ...
  String get animationDescription =>
      'Lines disappearing and reappearing from wide to narrow upward';
}
...
class _ArrowUpWideNarrowPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Line 1 (longest) - closest to arrow
    final paint1 = Paint()
